...
_gokrazy/extrafiles_amd64.tar:
	...
	mv _gokrazy/extrafiles_amd64/usr/local/bin/LICENSE _gokrazy/extrafiles_amd64/usr/local/bin/LICENSE.rest-server
...
_gokrazy/extrafiles_arm64.tar:
	...
	curl -fsSL https://github.com/restic/rest-server/releases/download/v0.11.0/rest-server_0.11.0_linux_arm64.tar.gz | \
		...
		rest-server_*/rest-server rest-server_*/LICENSE
	mv _gokrazy/extrafiles_arm64/usr/local/bin/LICENSE _gokrazy/extrafiles_arm64/usr/local/bin/LICENSE.rest-server
